...
export class cPublic extends Component {
    /* getInitialState() {
     return { errortext: ""};
     }*/
    ...
    handleLogin(event){
        ...
        this.props.dispatch(Public(title, contenta,0,data));
            ...
            <div style={{margin: '30px'}}><div className="am-g" >
                <div className="am-u-lg-6 am-u-md-8 am-u-sm-centered">
                    ...
                    <div className="am-form">
                        ...
                        <input type="text" name="date" id="date" defaultValue={this.state.date} />
                        <br/>
...
export default connect(select)(cPublic);